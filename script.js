...
// Owner ko handover karne se pehle ye details Firebase Console se update kar lena
 const firebaseConfig = {
    ...
    storageBucket: "shree-balaji-cafe-46c2c.firebasestorage.app",
...
// === 2. AUTO TABLE NUMBER LOGIC ===
const urlParams = new URLSearchParams(window.location.search);
const tableNo = urlParams.get('table') || 'Counter';
let cart = [];
        ...
        card.innerHTML = `
            ...
            <div class="card-body">
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; margin-top:auto;">
                    ...
                    <button class="add-btn" onclick="addToCart(${item.id}, event)">ADD</button>
                </div>
            </div>
        `;
...
function placeOrder() {
    ...
    const savedName = localStorage.getItem('balaji_name');
